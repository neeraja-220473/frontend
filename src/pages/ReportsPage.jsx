    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="bg-white p-6 rounded-lg shadow mb-6 hover:shadow-lg transition">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-700">Monthly Purchases</h3>
        </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow mb-6 hover:shadow-lg transition">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-700">Top Purchased Product</h3>
        </div>
        <p className="text-gray-600">Rice</p>
        <p className="text-gray-600">Total Quantity: 120 bags</p>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
        ...
        <p className="text-gray-500 mt-2">Across 25 orders</p>
      </div>
    </div>
  );
}