export default function BillingPage() {
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold mb-6">Billing / Invoice</h2>
      <div className="bg-white p-6 rounded shadow">
        ...
        <table className="w-full border my-4">
          ...
          <tbody>
            <tr>
              <td className="p-2 border">Rice Bags</td>
              <td className="p-2 border">2</td>
              <td className="p-2 border">₹2400</td>
            </tr>
            <tr>
              <td className="p-2 border">Oil Bottle</td>
        ...
        <div className="mt-4 flex space-x-4">
          ...
          <button className="bg-indigo-600 text-white px-4 py-2 rounded">Print</button>
        </div>
      </div>
    </div>
  );
